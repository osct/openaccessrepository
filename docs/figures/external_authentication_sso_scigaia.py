...
"""External user authentication for INFN Invenio."""
...
CFG_EXTERNAL_AUTH_SSO_LOGIN_VARIABLE = CFG_EXTERNAL_AUTH_SSO_PREFIX_NAME+'eppn'
# Name of the variable containing email
CFG_EXTERNAL_AUTH_SSO_EMAIL_VARIABLE = CFG_EXTERNAL_AUTH_SSO_PREFIX_NAME+'mail'
# Name of the variable containing groups
CFG_EXTERNAL_AUTH_SSO_GROUP_VARIABLE = CFG_EXTERNAL_AUTH_SSO_PREFIX_NAME+'affiliation'
# Separator character for group variable
CFG_EXTERNAL_AUTH_SSO_GROUPS_SEPARATOR = ';'

class ExternalAuthSSOSCIGAIA(ExternalAuth):
    """
    ...
    def auth_user(self, username, password, req=None):
        ...
        if req:
            ...
            if req.subprocess_env.has_key(CFG_EXTERNAL_AUTH_SSO_EMAIL_VARIABLE):
                from webuser import get_mail_from_mail_group
                return get_mail_from_mail_group(req.subprocess_env[CFG_EXTERNAL_AUTH_SSO_EMAIL_VARIABLE]), req.subprocess_env[CFG_EXTERNAL_AUTH_SSO_LOGIN_VARIABLE]
    ...
    def fetch_user_nickname(self, username, password=None, req=None):
        ...
        if req:
            ...
            if req.subprocess_env.has_key(CFG_EXTERNAL_AUTH_SSO_LOGIN_VARIABLE):
                return re.split('@',req.subprocess_env[CFG_EXTERNAL_AUTH_SSO_LOGIN_VARIABLE])[0]
        else:
            return None
